...
Stakater Cloud docs are built using [MkDocs](https://github.com/mkdocs/mkdocs) which is based on Python.
...
Then access the docs on [`localhost:8080/cloud`](localhost:8080/cloud).
